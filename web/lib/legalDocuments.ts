export const LEGAL_SUPPORT_EMAIL = 'quote.app.support@gmail.com';

export const DEFAULT_PRIVACY_POLICY_IT = `# Informativa sulla Privacy
...
Contatto privacy e supporto: [${LEGAL_SUPPORT_EMAIL}](mailto:${LEGAL_SUPPORT_EMAIL})
...
Le richieste possono essere inviate a [${LEGAL_SUPPORT_EMAIL}](mailto:${LEGAL_SUPPORT_EMAIL}).
...
export const DEFAULT_TERMS_OF_SERVICE_IT = `# Termini di Servizio
...
## 16. Contatti
Per supporto o richieste relative ai presenti termini: [${LEGAL_SUPPORT_EMAIL}](mailto:${LEGAL_SUPPORT_EMAIL})
`;
